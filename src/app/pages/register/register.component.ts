...
import { register, AuthService } from 'src/app/layouts/auth-layout/auth.service';
import { EmailValidator,passValidator,PhoneValidator,NameValidator} from '../validation';
